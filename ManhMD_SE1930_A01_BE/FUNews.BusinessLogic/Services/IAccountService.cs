...
public interface IAccountService
{
    ...
    Task<AccountDto> GetProfileAsync(short accountId, CancellationToken cancellationToken = default);
    Task<AccountDto> UpdateProfileAsync(short accountId, UpdateProfileRequestDto request, CancellationToken cancellationToken = default);
    Task ChangePasswordAsync(short accountId, ChangePasswordRequestDto request, CancellationToken cancellationToken = default);
}
